...
/**
 * Privacy Subsystem implementation for theme_aulas_toribio.
 *
...
namespace theme_aulas_toribio\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_aulas_toribio');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_aulas_toribio');
            }
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_aulas_toribio');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_aulas_toribio');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_aulas_toribio',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_aulas_toribio');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_aulas_toribio');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_aulas_toribio',
