 ...
 *
 * @module     theme_aulas_toribio/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_aulas_toribio/drawers:show}
     * @property {String} drawerShown See {@link event:theme_aulas_toribio/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_aulas_toribio/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_aulas_toribio/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_aulas_toribio/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_aulas_toribio/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_aulas_toribio/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_aulas_toribio/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_aulas_toribio/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_aulas_toribio/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_aulas_toribio/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_aulas_toribio/drawers:hidden',
    };
     ...
     * @returns {module:theme_aulas_toribio/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_aulas_toribio/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_aulas_toribio/drawers:close');
     ...
     *
     * @param {module:theme_aulas_toribio/drawers} comparisonInstance
     */
